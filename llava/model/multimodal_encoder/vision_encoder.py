...
class VisionTower(nn.Module):
    ...
    def forward(self, images):
        # print(f"[VisionTower] input images type: {type(images)}")
        # if isinstance(images, torch.Tensor):
        #     print(f"[VisionTower] input images shape: {images.shape}")
        # else:
        #     print(f"[VisionTower] input images is list of length {len(images)}")
